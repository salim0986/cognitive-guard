...
class StatsTracker:
    ...
    ACHIEVEMENTS = [
        ...
        Achievement(
            "perfectionist", "💯 Perfectionist", "Achieve 100% documentation coverage", "💯"
        ),
    ]
    ...
    def record_documentation(self, complexity: int) -> None:
        ...
        self.stats.highest_complexity_documented = max(
            self.stats.highest_complexity_documented, complexity
        )
    ...
    def display(self, console: Console) -> None:
        ...
        bar_length = 10
        filled = (
            int((current_coverage / target_coverage) * bar_length) if target_coverage > 0 else 0
        )
